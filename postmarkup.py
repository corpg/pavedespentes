...
#TODO: rendre ca automatique !
""" Short configuration """
DOMAIN = "pavedespentes.fr" #desactive l'annotation des liens pour le domaine
""" End of short configuration """
...
class LinkTag(TagBase):
    ...
    def annotate_link(self, domain=None):
        ...
        if domain and domain != DOMAIN and self.annotate_links:
...
""" Aligner à droite un paragraphe. """
class RightAlignTag(TagBase):
